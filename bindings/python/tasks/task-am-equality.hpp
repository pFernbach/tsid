...
namespace tsid
{
  ...
  {    
    ...
    : public boost::python::def_visitor< TaskAMEqualityPythonVisitor<TaskAM> >
    {
      ...
      static math::ConstraintEquality compute(TaskAM & self, const double t, const Eigen::VectorXd & q, const Eigen::VectorXd & v, const se3::Data & data){
      ...
      static const Eigen::Vector3d & momentum_ref (const TaskAM & self){
        return self.momentum_ref();
      }
      static const Eigen::Vector3d & dmomentum_ref (const TaskAM & self){
